public class Main {
    public static void main(String[] args) {
        ...
        Book sayNothing = new Book("Say Nothing", "Patrick Radden Keefe", 2018, 364.1523); // Non-fiction
        Book inColdBlood = new Book("In Cold Blood", "Truman Capote", 1966, 364.1523); // Non-fiction
